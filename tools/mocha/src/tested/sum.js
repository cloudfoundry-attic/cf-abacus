...
var straight = function(x, y) { return x + y; };

// Here only one of the branches in the conditional is covered
var cond = function(x, y) { return x === 0 ? y : x === 1 ? 1 + y : x + y; };

// Again here, only one of the branches is covered
/* eslint no-else-return: 1 */
var ifelse = function(x, y) { if (x === 0) return y; else if (x === 1) return 1 + y; else return x + y; };

// A function that is not covered
var blah = function() { return 'boo'; };
