...
const cfg = {
  ...
  auth_server: process.env.AUTH_SERVER || 'http://localhost:9882',
  collector: process.env.COLLECTOR || 'http://localhost:9080',
...
const startApp = async () => {
  ...
  const collectorClient = throttledClient(new CollectorClient(cfg.collector, authHeaderProvider, cfg.skipSslValidation));
