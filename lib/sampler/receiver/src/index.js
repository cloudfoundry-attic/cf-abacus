...
const cfg = {
  ...
  provisioning: process.env.PROVISIONING || 'http://localhost:9880',
...
const startApp = async () => {
  ...
  const provisioningClient = new ProvisioningClient(cfg.provisioning, authHeaderProvider, cfg.skipSslValidation);
