...
describe('abacus-metering-schemas', () => {
  describe('validate schema for a metering plan', () => {
      ...
      expect(error).to.deep.equal({
        ...
        message: [
          ...
          },
          {
            ...
            message: 'is required',
            schemaPath: [ 'properties', 'measures', 'items' ],
          ...
          },
          {
            ...
            message: 'is required',
            schemaPath: [ 'properties', 'metrics', 'items' ],
            value: def.metrics[1]
          },
          {
            type: 'object',
    ...
    const validateMeteringPlan = (aggregateFunction, expectedError) => {
          ...
          message: [
            {
              ...
              schemaPath: [ 'properties', 'metrics', 'items', 'properties', 'aggregate' ],
              type: 'string',
    ...
    it('reports valid plan containing functions with non used args', () => {
      const aggregateFunction =
        `(a, prev, curr, ${unusedVar}) => ` + 'new BigNumber(a || 0).add(curr).sub(prev).toNumber()';
        ...
        expect(e).to.deep.equal({
          ...
          message: [
            ...
            },
            {
              ...
              schemaPath: [ 'properties', 'metrics', 'items', 'properties', 'prices' ],
            ...
            },
            {
              ...
              message: 'is required',
              schemaPath: [ 'properties', 'metrics', 'items', 'properties', 'prices', 'items' ],
