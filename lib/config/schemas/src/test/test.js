...
// Add mock resources to abacus-resource-config module
...
describe('abacus-metering-schemas', () => {
  ...
  describe('validate resource usage', () => {
    ...
    it('validate resource usage with invalid consumer type', () => {
      const usage = {
        id: '123',
        usage: [{
          start: 1420243200000,
    ...
    it('validate resource usage with invalid resource id', () => {
      const usage = {
        usage: [{
          start: 1420243200000,
          end: 1420245000000,
