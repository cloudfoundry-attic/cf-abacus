    ...
    return brequest.get(uris.provisioning +
      ...
      if (val.statusCode !== 200) {
        ...
        return unlock(cb(undefined, error('epplannotfound',
          `Pricing plan with id ${ppid} not found`, val
        )));
      }
  ...
  return lock(key, (err, unlock) => {
    ...
    extend({}, o, {
      ...
      if (val.statusCode !== 200) {
        ...
        return unlock(cb(undefined, error('eppidnotfound',
          `Pricing plan id for resource type ${rtype} ` +
