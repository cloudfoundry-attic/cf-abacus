...
// Return the cost aggregate function for a given metric
const costaggregatefn = (t) => t.cost_aggregate ?
  xeval(t.cost_aggregate) : sum;
  ...
  return extend(clone(resource), {
    ...
    metrics: map(resource.metrics, (t) => {
      return extend(clone(t), {
        ...
        ratefn: ratefn(t),
        costaggregatefn : costaggregatefn(t),
        reportfn: reportfn(t)
      });
    })
  });
