...
// Setup debug log
const debug = require('cf-abacus-debug')('cf-abacus-usage-meter');

// Resolve service URIs
const uris = urienv({ couchdb: 5984, accumulator: 9100 });

// Configure metered usage db
const meterdb = yieldable(batch(retry(breaker(db(uris.couchdb, 'abacus-metered-usage')))));
...
routes.post('/v1/metering/usage', function *(req) {
...
routes.get('/v1/metering/metered/usage/:id', function *(req) {
