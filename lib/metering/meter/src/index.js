...
const meterConfig = createMeterConfiguration(bufferConfig);
...
const startApp = async() => {
  ...
  const token = meterConfig.token(uris().auth_server);
  ...
  const connectionManager = new ConnectionManager(meterConfig.rabbitMQ.uri);
