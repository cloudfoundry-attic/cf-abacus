...
// Return resource consumers for a given resource id
...
const consume = (a) => {
  return (u) => {
    ...
    // If there is an consumer function then use it, else parse the formula,
    // construct consumer function and then evaluate
