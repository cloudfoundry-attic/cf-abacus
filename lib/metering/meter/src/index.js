...
const dbPartitions = process.env.DB_PARTITIONS ? parseInt(process.env.DB_PARTITIONS) : 4;
...
const errorDbDefaultPartitioner =
  dbClient(defaultPartitioner, dbClient.dburi(uris()[dbalias], 'abacus-business-errors'));
const outputDbDefaultPartitioner = dbClient(defaultPartitioner, dbClient.dburi(uris()[dbalias], 'abacus-meter'));
