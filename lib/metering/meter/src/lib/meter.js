...
class Meter {
  ...
  async meterUsage(usageDoc) {
    ...
    try {
      // console.log(meteringPlan.metering_plan.metrics);
      // console.log(meteringPlan);
      // const mu = map(meteringPlan.metering_plan.metrics, (metric) => ({
      //   metric: metric.name,
      //   quantity: metric.meterfn(meterInput)
      // }));
      // console.log(mu);

      // TODO fix unit test and describe the expected meteringPlan structure
