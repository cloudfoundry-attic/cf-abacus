...
const submitdb = yieldable(batch(retry(breaker(db(uris.couchdb, 'abacus-submitted-usage')))));
const normdb = yieldable(batch(retry(breaker(db(uris.couchdb, 'abacus-normalized-usage')))));
...
// Store a batch of usage data for the given service
routes.post('/v1/metering/services/:service_id/usage', function *(req) {
...
// Store a batch of usage data for the given service instance
routes.post('/v1/metering/service_instances/:service_instance_id/usage', function *(req) {
...
routes.get('/v1/metering/services/:service_id/usage/:id', function *(req) {
...
routes.get('/v1/metering/service_instances/:service_instance_id/usage/:id', function *(req) {
...
routes.get('/v1/metering/usage/:id', function *(req) {
