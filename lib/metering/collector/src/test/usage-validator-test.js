  ...
  context('validate schema', () => {
    ...
    context('with invalid schema', () => {
      it('should throw with valid error', async() => {
        ...
        const expectedError = { badRequest: true, error: 'Invalid schema' };
  ...
  context('validate plan', () => {
    ...
    context('with invalid plan', () => {
      it('should throw with valid error', async() => {
        ...
        let actualError = null;
        const expectedError = { badRequest: true, error: 'Invalid plan' };
    ...
    context('with provisioning down', () => {
      it('should throw with valid error', async() => {
        ...
        let actualError = null;
        const expectedError = { badRequest: false, error: 'Unable to retrieve metering plan' };
