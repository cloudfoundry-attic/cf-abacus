...
describe('abacus-usage-collector', () => {
  it('stores and retrieves service usage data', function(done) {
    this.timeout(60000);
  ...
  it('stores and retrieves service instance usage data', function(done) {
    this.timeout(60000);
    ...
    request.post('http://localhost::p/v1/metering/service_instances/' +
