  ...
  context('when application groups are provided', () => {
      ...
      context('when single app per group', () => {
        ...
        beforeEach(async() => {
          ...
          const applicationsUrisBuilderStub = {
            buildUris: sandbox.stub().returns([appUri])
          };
      ...
      context('when multiple apps per group', () => {
        ...
        beforeEach(async() => {
          ...
          applicationsUrisBuilderStub = {
            buildUris: sandbox.stub().returns([app0Uri, app1Uri])
          };
    ...
    context('when multiple groups are provided', () => {
      ...
      beforeEach(async() => {
        ...
        buildUrisStub.withArgs(aggregatorGroup, 1).returns([aggregatorUri]);
        buildUrisStub.withArgs(accumulatorGroup, 2).returns([accumulator0Uri, accumulator1Uri]);
