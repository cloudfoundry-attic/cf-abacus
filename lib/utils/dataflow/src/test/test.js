...
const { extend, keys, map, omit, times } = require('underscore');
          ...
          (accum, ival, i, l, cb) => {
            ...
            request.post(
              ...
              (err, pval) => {
                ...
                // TODO No location header when 500 is returnd in dataflow buildPlayResponse
                // Get the input doc
                // request.get(pval.headers.location, {}, (err, val) => {
                //   expect(err).to.equal(undefined);
                //   expect(val.statusCode).to.equal(200);
        ...
        (accum, ival, i, l, cb) => {
          ...
          request.post(
            ...
            (err, pval) => {
              ...
              // TODO location header in case of 500 in playResponse.
              // The comment code below works when there is no error (ival>=7)
    ...
    context('on business error', () => {
      ...
      it('returns correct status code when timeout error occurs', (done) => {
        ...
        post((err, resp) => {
          ...
          expect(omit(err, 'Error', 'code')).to.deep.equal({ statusCode: 500 });
          done();
        });
      });
        ...
        (accum, ival, i, l, cb) => {
          ...
          request.post(
            ...
            (err, pval) => {
              ...
              // TODO location header in case of 500 in playResponse.
              // The comment code below works when there is no error (ival=9)
        ...
        (accum, ival, i, l, cb) => {
          ...
          request.post(
            ...
            (err, pval) => {
              ...
              // TODO location header in case of 500 in playResponse.
              // The comment code below works when there is no error
              ...
              request.post(
                ...
                (err, pval) => {
                  ...
                  if (ival >= 7) {
                    ...
                    // Get error docs
                    request.get(
                      'http://localhost::p/v1/enbs/' + 't/:tstart/:tend/get/error',
                      {
                        p: server.address().port,
                        auth: {
                          bearer: 'test'
