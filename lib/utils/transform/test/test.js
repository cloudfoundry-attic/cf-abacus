...
describe('cf-abacus-transform', () => {
    it('runs a reduction function asynchronously', () => {
        ...
        const sum = (a, v, i, l, cb) => process.nextTick(() => cb(undefined, a + v));
        ...
        const esum = (a, v, i, l, cb) => process.nextTick(() => cb(err, 0));
    ...
    it('runs a map function asynchronously', () => {
        ...
        // Run a map function
        const sqr = (v, i, l, cb) => process.nextTick(() => cb(undefined, v * v));
        ...
        const esqr = (v, i, l, cb) => process.nextTick(() => cb(err, 0));
    ...
    it('runs a filter function asynchronously', () => {
        ...
        const even = (v, i, l, cb) => process.nextTick(() => cb(undefined, v % 2 === 0));
        ...
        const eeven = (v, i, l, cb) => process.nextTick(() => cb(err, 0));
