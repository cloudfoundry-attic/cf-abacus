...
describe('Write carry-over usage', () => {
  ...
  context('on success', () => {
    ...
    beforeEach((done) => {
      ...
      map(appUsage, (usage) => {
        carryOver.write(usage, usageResponse, undefined, (opError) => {
  ...
  context('on failure', () => {
    context('when new app cannot be read', () => {
      ...
      beforeEach((done) => {
        ...
        carryOver = require('..')(statistics, errorFn);
        map(appUsage, (usage) => {
          carryOver.write(usage, usageResponse, undefined, countingCb);
        });
      });
  ...
  context('with a event for a known app', () => {
    ...
    beforeEach((done) => {
      ...
      carryOver = require('..')(statistics, errorFn);
      carryOver.write(appUsage[0], usageResponse, newResourceState,
        (opError) => {
