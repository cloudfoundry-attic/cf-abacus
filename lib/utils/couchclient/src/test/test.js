...
describe('abacus-couchclient', (d) => {
  const helloKey = couchclient.kturi('Hello', moment(
    '2014-11-06 19:06:54').valueOf());
  const helloAgainKey = couchclient.kturi('Hello', moment(
    '2014-11-06 19:07:54').valueOf());
  const heyKey = couchclient.tkuri('Hey', moment(
    '2014-10-06 19:06:54').valueOf());
  const blahKey = couchclient.kturi('Blah', moment(
    '2014-10-06 19:06:54').valueOf());
  const awwwwKey = couchclient.kturi('Awwww', moment(
    '2014-11-06 19:06:54').valueOf());
  ...
  it('distributes bulk operations over 4 db partitions', (done) => {
    ...
    const getrangeerr = (done) => {
      ...
      db.allDocs({
        include_docs: true,
        startkey: couchclient.kturi('Blah',moment(
          '2014-10-05 19:06:54').valueOf()),
        endkey: couchclient.kturi('Blah', moment(
