...
const iterable = require('abacus-iterable');
...
const rand = (n, d, p, mu = 0, std = 0.08) => {
...
const dwrand = (n, d, p, mu = 0, std = 0.08) => {
...
module.exports = { pool, clear, alloc, dense, idense, get, set, toCSR, toCSC,
  toDense, dwmatrix, rand, dwrand };
