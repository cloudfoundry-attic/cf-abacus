...
describe('ProvisioningClient', () => {
  ...
  before(async () => {
    ...
    app.put(`/v1/metering/plans/${planId}`, updateMeteringPlanMiddleware);
    updateRatingPlanMiddleware = middlewareSandbox.stub();
    app.put(`/v1/rating/plans/${planId}`, updateRatingPlanMiddleware);
    updatePricingPlanMiddleware = middlewareSandbox.stub();
    app.put(`/v1/pricing/plans/${planId}`, updatePricingPlanMiddleware);
