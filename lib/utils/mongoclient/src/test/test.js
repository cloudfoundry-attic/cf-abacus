...
describe('abacus-mongoclient', () => {
  const helloKey = dbclient.kturi('Hello', moment(
    '2014-11-06 19:06:54').valueOf());
  const helloAgainKey = dbclient.kturi('Hello', moment(
    '2014-11-06 19:07:54').valueOf());
  const heyKey = dbclient.tkuri('Hey', moment(
    '2014-10-06 19:06:54').valueOf());
  const blahKey = dbclient.kturi('Blah', moment(
    '2014-10-06 19:06:54').valueOf());
  const awwwwKey = dbclient.kturi('Awwww', moment(
    '2014-11-06 19:06:54').valueOf());
  ...
  it('distributes bulk operations over 4 db partitions', (done) => {
    ...
    const getrangeerr = (done) => {
      ...
      db.allDocs({
        include_docs: true,
        startkey: dbclient.kturi('Blah', moment(
          '2014-10-05 19:06:54').valueOf()),
        endkey: dbclient.kturi('Blah', moment(
