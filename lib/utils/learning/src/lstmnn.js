...
const { dwmatrix, dwrand } = require('abacus-matrix');
const { rowPluck, mul, tanh, sigmoid, add, eltmul } = require('./compgraph');

/* eslint dot-notation: 0 */

// Return a new LSTM network
// Network configuration initially derived = require(the recurrentjs library
// (https://github.com/karpathy/recurrentjs)
const network = (isize, esize, hsizes, osize) => {
...
// and cell = require(the previous iteration.
const forward = (net, G, ix, state) => {
...
module.exports = { network, forward };
