        ...
        const cb = spy(() => {
            if(cb.args.length === 3) {
                expect(cb.args).to.deep.equal([
                    [undefined, { done: false, value: { name: 'message', value: { x: 1 }}}], [undefined, { done: false, value: { name: 'message', value: { x: 2 }}}],
                    [undefined, { done: false, value: { name: 'message', value: { x: 3 }}}]]);
                done();
            }
        });
        i.next(cb);
