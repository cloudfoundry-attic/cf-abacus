...
class Counter {
  ...
  report() {
    ...
    return {
      ...
      intervals: {
        previous_second: {
          rate: this.secondsWindow.calculatePreviousRate(currentTime)
        },
        current_second: {
          rate: this.secondsWindow.estimateCurrentRate(currentTime)
        },
        previous_minute: {
          rate: this.minutesWindow.calculatePreviousRate(currentTime)
        },
        current_minute: {
          rate: this.minutesWindow.estimateCurrentRate(currentTime)
        },
        previous_hour: {
          rate: this.hoursWindow.calculatePreviousRate(currentTime)
        },
        current_hour: {
          rate: this.hoursWindow.estimateCurrentRate(currentTime)
        }
      }
    };
  }
