    ...
    describe('report', () => {
      ...
      describe('second interval', () => {
        describe('previous rate', () => {
          const getPreviousRate = () => {
            const report = counter.report();
            return report.intervals.previous_second.rate;
          };
        ...
        describe('current rate', () => {
          const getCurrentRate = () => {
            const report = counter.report();
            return report.intervals.current_second.rate;
          };
      ...
      describe('minute interval', () => {
        describe('previous rate', () => {
          const getPreviousRate = () => {
            const report = counter.report();
            return report.intervals.previous_minute.rate;
          };
        ...
        describe('current rate', () => {
          const getCurrentRate = () => {
            const report = counter.report();
            return report.intervals.current_minute.rate;
          };
      ...
      describe('hour', () => {
        describe('previous rate', () => {
          const getPreviousRate = () => {
            const report = counter.report();
            return report.intervals.previous_hour.rate;
          };
        ...
        describe('current rate', () => {
          const getCurrentRate = () => {
            const report = counter.report();
            return report.intervals.current_hour.rate;
          };
