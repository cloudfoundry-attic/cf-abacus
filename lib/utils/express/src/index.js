...
const maxInternalInflight = process.env.MAX_INTERNAL_INFLIGHT || 4;
const maxClientInflight = maxInflight - maxInternalInflight;
...
const expressApp = () => {
  ...
  app.use(inflight(maxClientInflight, maxInternalInflight, secured));
