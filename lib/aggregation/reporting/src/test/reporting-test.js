...
describe('abacus-usage-report', () => {
  ...
  context('when rated usage contains small numbers', () => {
    before((done) => {
      ...
      const rated = builder.ratedTemplate(id, oid, sid, testResourceId,
        ...
        1420502500000, builder.buildAggregatedUsage(21, 300, 3300, {
          ...
          builder.consumerReferenceTemplate(
      ...
      builder.storeRatedUsage(rated, () => builder.storeRatedUsage(consumer1,
        () => builder.storeRatedUsage(consumer2, done)));
    });
    ...
    it('retrieves rated usage for an organization', (done) => {
      ...
      const expected = reportTemplate(id, 
        ...
        builder.buildAggregatedUsage(undefined, undefined, undefined, undefined,
      ...
      const verify = (secured, done) => {
        ...
        const getRatedUsageRequestForTime = (requestDone) => {
          request.get(
            'http://localhost::p/v1/metering/organizations/' +
            ':organization_id/aggregated/usage/:time', {
              p: server.address().port,
        ...
        async.parallel([
          getRatedUsageRequest,
          getRatedUsageRequestForTime], done);
      };
  ...
  context('when rated usage contains big numbers', () => {
    before((done) => {
      builder.storeRatedUsage(require('./json/big-number-rated.json'), () => 
        builder.storeRatedUsage(require('./json/consumer-1.json'), () =>
        builder.storeRatedUsage(require('./json/consumer-2.json'), () => 
        builder.storeRatedUsage(require('./json/consumer-3.json'), () =>
        builder.storeRatedUsage(require('./json/consumer-4.json'), () => 
        builder.storeRatedUsage(require('./json/consumer-5.json'), done))))));
    });
    ...
    before((done) => {
      ...
      const rated = builder.ratedTemplate(id, orgid, sid, testResourceId,
        ...
        1446418800000, [{
          ...
          builder.consumerReferenceTemplate(orgid, sid, 'basic',
      ...
      builder.storeRatedUsage(rated, () => builder.storeRatedUsage(consumer,
        () => builder.storeRatedUsage(consumer2, done)));
    });
  ...
  context('when accumulated usage has small numbers', () => {
    ...
    before((done) => {
      ...
      builder.storeAccumulatedUsage(accumulated, done);
    });
