...
describe('abacus-usage-report', () => {
  ...
  context('when rated usage contains small numbers', () => {
    before((done) => {
      ...
      storage.storeRatedUsage(rated, () => storage.storeRatedUsage(consumer1,
        () => storage.storeRatedUsage(consumer2, done)));
    });
  ...
  context('when rated usage contains big numbers', () => {
    before((done) => {
      storage.storeRatedUsage(require('./json/big-number-rated.json'), () => 
        storage.storeRatedUsage(require('./json/consumer-1.json'), () =>
        storage.storeRatedUsage(require('./json/consumer-2.json'), () => 
        storage.storeRatedUsage(require('./json/consumer-3.json'), () =>
        storage.storeRatedUsage(require('./json/consumer-4.json'), () => 
        storage.storeRatedUsage(require('./json/consumer-5.json'), done))))));
    });
  ...
  context('when rated usage contains a slack', () => {
    before((done) => {
      ...
      storage.storeRatedUsage(rated, () => storage.storeRatedUsage(consumer,
        () => storage.storeRatedUsage(consumer2, done)));
    });
  ...
  context('when accumulated usage has small numbers', () => {
    ...
    before((done) => {
      ...
      storage.storeAccumulatedUsage(accumulated, done);
    });
