...
const cdid = (orgid, cid, t) =>
  ['k', orgid, cid, 't', t].join('/');
...
const ratedConsumerTemplate = (orgid, plan, a, p, processed, coid) => ({
  id: cdid(orgid, coid || cid(plan), processed),
...
const consumerReferenceTemplate = (orgid, plan, processed, conid) => ({
  id: conid || cid(plan),
  t: processed + ''
});
    ...
    before((done) => {
      ...
      const rated = ratedTemplate(id, oid, 1420502400000, 1420502500000,
        1420502500000,buildAggregatedUsage(21, 300, 3300, {
          ...
          consumerReferenceTemplate(orgid, 'basic', 1420502500000,
           'UNKNOWN'),
          consumerReferenceTemplate(orgid, 'standard', 1420502500000,
           'external:bbeae239-f3f8-483c-9dd0-de6781c38bab')
        ]);
    ...
    before((done) => {
      ...
      const rated = ratedTemplate(id, orgid, 1446415200000, 1446415200000,
        1446418800000, [{
          ...
          metric: 'memory',
          windows: planWindow
        }])], [consumerReferenceTemplate(orgid, 'basic', 1446418800000,
           'UNKNOWN'),consumerReferenceTemplate(orgid, 'basic',
