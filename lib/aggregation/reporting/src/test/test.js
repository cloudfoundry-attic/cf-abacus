...
const cdid = (oid, sid, cid, t) =>
  ['k', oid, sid, cid, 't', t].join('/');
...
const accid = 'k/a3d7fe4d-3cb1-4cc3-a831-ffe98e20cf27/UNKNOWN/' +
...
const ratedConsumerTemplate = (plan, a, p, processed, id) => ({
  id: cdid(oid, sid, id || cid(plan), processed),
  consumer_id: id || cid(plan),
  processed: processed,
  resources: [{
...
const ratedTemplate = (id, start, end, processed, a, p, c) => ({
  id: id,
  organization_id: oid,
  account_id: '1234',
  start: start,
...
describe('abacus-usage-report', () => {
  ...
  context('when rated usage contains small numbers', () => {
    before((done) => {
      ...
      const rated = ratedTemplate(id, 1420502400000, 1420502500000,
      ...
      const consumer1 = ratedConsumerTemplate('basic',
      ...
      const consumer2 = ratedConsumerTemplate('standard',
  ...
  context('when rated usage contains a slack', () => {
    before((done) => {
      ...
      const id = 'k/a3d7fe4d-3cb1-4cc3-a831-ffe98e20cf27/t/0001446418800000';

      const rated = ratedTemplate(id, 1446415200000, 1446415200000,
        1446418800000, [{
          metric: 'memory',
          windows: aggrWindow
          ...
          metric: 'memory',
          windows: planWindow
        }])], ['UNKNOWN/t/1446418800000', 'UNKNOWN2/t/1446163200000']);

      const consumer = ratedConsumerTemplate('basic', [{
        metric: 'memory',
        windows: aggrWindow
      }], [buildPlanUsage('basic', [{
        metric: 'memory',
      ...
      const consumer2 = ratedConsumerTemplate('basic', [{
        metric: 'memory',
        windows: aggrWindow
      }], [buildPlanUsage('basic', [{
        metric: 'memory',
    ...
    it('checks that time-based resource uses its bounds', (done) => {
      ...
      // The month should match the day. There is a bug here where the end
      // passed is the end of november instead of october
      const expectedMonth = {
        summary: 48,
        charge: 0.00672,
        quantity: {
