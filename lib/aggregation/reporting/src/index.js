...
const reportType = schemas.usageReport.graphql();

const graphSchema = new GraphQLSchema({
  query: new GraphQLObjectType({
    name: 'query',
    fields: () => ({
        organization: extend(clone(reportType.getFields().organization, {
          args: {
            organization_id: {
        ...
        organizations: extend(clone(reportType.getFields().organizations, {
          args: {
            organization_ids: {
        ...
        account: extend(clone(reportType.getFields().account, {
          args: {
            account_id: {
              name: 'account_id',
              type: new GraphQLNonNull(GraphQLString)
