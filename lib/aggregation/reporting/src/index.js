...
const uris = urienv({
  account: 9881,
  auth_server: 9882,
  accumulator_db_uri: 5984,
  aggregator_db_uri: 5984
});

// Configure rated usage db
const aggregatordb = dataflow.db('abacus-aggregator-aggregated-usage', undefined, uris.accumulator_db_uri);
// Configure accumulated usage db
const accumulatordb = dataflow.db('abacus-accumulator-accumulated-usage', undefined, uris.aggregator_db_uri);
...
const resourceInstanceUsage = function*(
  ...
  return summarizedInstanceReport;
};
