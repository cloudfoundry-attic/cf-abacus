...
const accumulate = function*(accums, usage) {
  ...
  const currentQuantity = (timeWindow) =>
    timeWindow && timeWindow.quantity && timeWindow.quantity.current
      ...
      return {
        ...
        windows: map(accumulateWindow, (window, i) => {
          ...
          return map(window, (timeWindow, j) => {
            ...
            const current = currentQuantity(timeWindow);
