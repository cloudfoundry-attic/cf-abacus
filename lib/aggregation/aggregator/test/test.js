...
const configmock = (sid) => ({ id: '1234', aggregations: [{ id: 'calls', aggregate: (a, qty) => a ? a + qty : qty }]});

const aggregator = proxyquire('..', { 'cf-abacus-webapp': webapp, 'cf-abacus-service-config': configmock });
