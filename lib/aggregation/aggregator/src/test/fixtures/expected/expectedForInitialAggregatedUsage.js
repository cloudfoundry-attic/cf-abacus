...
const aggregatesInitialUsageExpected = [
  {
    ...
    'id': `k/${testOrganizationID}/t/0001446292800000-0-0-0-0`,
  ...
  },
  {
    ...
    'processed': 1446292800000,
    'accumulated_usage_id': `t/0001446292800000-0-0-0-0/k/${testOrganizationID}`,
    'id': `k/${testOrganizationID}/${testSpaceID}/${testConsumerID}/t/0001446292800000-0-0-0-0`,
    'processed_id': '0001446292800000'
  },
  {
    'space_id': testSpaceID,
    ...
    'processed': 1446292800000,
    'accumulated_usage_id': `t/0001446292800000-0-0-0-0/k/${testOrganizationID}`,
    'id': `k/${testOrganizationID}/${testSpaceID}/t/0001446292800000-0-0-0-0`,
    'processed_id': '0001446292800000'
  },
  {
    'processed': 1446292800000,
    'accumulated_usage_id': `t/0001446292800000-0-0-0-0/k/${testOrganizationID}`,
    'id': `k/${testOrganizationID}/${testResourceInstanceIDs[0]}/${testConsumerID}/${testPlanID}/${testMeteringPlanID}` 
    + `/${testRatingPlanID}/${testPricingPlanID}/t/0001446251400000/0001446249600000`,
    'processed_id': '0001446292800000'
  }
];
