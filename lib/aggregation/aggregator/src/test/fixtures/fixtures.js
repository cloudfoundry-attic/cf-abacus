...
const createUsage = (quantity) => buildUsage(
...
const aggregatedUsage = {
  withNull: createUsage(null),
  withNaN: createUsage(NaN),
  withUndefined: createUsage(undefined)
};

module.exports = { 
  aggregatesInitialUsageFixture, aggregatesWithExisitingUsageFixture, shiftsMonthWindowsFixture, 
  aggregatesWithZeroFixture, aggregatedUsage
};
