...
//     withProcessedTimestamp(startOfNovemberEightAM),
//     withAccumulatedUsage([
//       buildAccumulatedUsage1(
//         withMetricName('heavy_api_calls'),
//         withCurrentDayQuantity({ previous: 12, current: 22 }),
...
//       buildAccumulatedUsage1(
//         withMetricName('heavy_api_calls'),
//         withCurrentDayQuantity({ previous: 22, current: 33 }),
//         withCurrentMonthQuantity({ previous: 22, current: 33 })
//       )
//     ]))
// ];
...
const usageForTwoMonthsFixture = {
  usage: usageForTwoMonths,
  expected: {}
};
...
module.exports = { 
  ...
  aggregatesInitialUsageFixture, aggregatesWithExisitingUsageFixture, usageForTwoMonthsFixture
};
