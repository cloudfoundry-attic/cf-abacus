...
const { shiftWindowsTestFixtures, aggregatesInitialUsageFixture,
  aggregatesWithExisitingUsageFixture, shiftsWindowsFixture } = require('./fixtures/fixtures'); 
...
describe('abacus-usage-aggregator', () => {
  ...
  it('shifts windows successfully', async() => {
    startAggregator();
    await sendUsage(aggregatesInitialUsageFixture.usage);
    await sendUsage(shiftsWindowsFixture.usage);
  });
