...
describe('abacus-usage-aggregator', () => {
  it('constructs aggregated usage for an organization', () => {
    ...
    agg[0].resource('object-storage').metric('calls').quantity = 12;
    agg[0].resource(
      'object-storage').plan('basic').metric('calls').quantity = 12;
    agg[0].space(
      'aaeae239-f3f8-483c-9dd0-de5d41c38b6a').resource(
        'object-storage').metric('calls').quantity = 12;
    agg[0].space(
      'aaeae239-f3f8-483c-9dd0-de5d41c38b6a').resource(
        'object-storage').plan('basic').metric('calls').quantity = 12;
    agg[0].space(
    ...
    agg[1].resource('object-storage').metric('calls').quantity = 22;
    agg[1].resource(
        'object-storage').plan('basic').metric('calls').quantity = 22;
    agg[1].space(
      'aaeae239-f3f8-483c-9dd0-de5d41c38b6a').resource(
        'object-storage').metric('calls').quantity = 22;
    agg[1].space(
      'aaeae239-f3f8-483c-9dd0-de5d41c38b6a').resource(
        'object-storage').plan('basic').metric('calls').quantity = 22;
    agg[1].space(
