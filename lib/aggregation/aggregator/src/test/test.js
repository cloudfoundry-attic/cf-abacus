...
// Template for creating accumulated usage used in V2
// const accumulatedUsageV2 = (rid, s, e, p, rp, pi, api, mem) => ({
//   collected_usage_id: '555',
//   resource_id: 'test-resource',
//   resource_instance_id: rid,
//   start: s,
...
describe('abacus-usage-aggregator V2', () => {
  let clock;
  ...
  it('constructs aggregated usage for an organization - V2', () => {
    // Define the aggregated usage we're expecting
    const aggregated = [{
      organization_id: 'a3d7fe4d-3cb1-4cc3-a831-ffe98e20cf27',
      resources: [
    ...
    // Construct aggregated usage using an org aggregated usage object
    const agg = [];
    agg[0] = aggregator.newOrgV2('a3d7fe4d-3cb1-4cc3-a831-ffe98e20cf27');
    agg[0].resource('test-resource').metric('heavy_api_calls').windows = [
      [{ quantity: 12 }], [{ quantity: 22 }],
      [{ quantity: 32 }], [{ quantity: 42 }],
      [{ quantity: 52 }]];
    agg[0].resource(
      'test-resource').metering_plan('basic').metric(
        'heavy_api_calls').windows = [
          [{ quantity: 12 }], [{ quantity: 22 }],
          [{ quantity: 32 }], [{ quantity: 42 }],
          [{ quantity: 52 }]];
    agg[0].resource(
      'test-resource').metering_plan('basic').rating_plan('basic').metric(
        'heavy_api_calls').windows = [
          [{ quantity: 12 }], [{ quantity: 22 }],
          [{ quantity: 32 }], [{ quantity: 42 }],
          [{ quantity: 52 }]];
    agg[0].resource(
      'test-resource').metering_plan('basic').rating_plan('basic').price(
        'common').metric('heavy_api_calls').windows = [
          [{ quantity: 12, cost: 1 }], [{ quantity: 22, cost: 2 }],
          [{ quantity: 32, cost: 3 }], [{ quantity: 42, cost: 4 }],
          [{ quantity: 52, cost: 5 }]];
    agg[0].space(
    ...
    // Serialize to JSON to simulate db storage and retrieval, then revive
    // the org object behavior
    agg[1] = aggregator.reviveOrgV2(JSON.parse(JSON.stringify(agg[0])));
    agg[1].resource('test-resource').metric('heavy_api_calls').windows = [
      [{ quantity: 112 }], [{ quantity: 122 }],
      [{ quantity: 132 }], [{ quantity: 142 }],
      [{ quantity: 152 }]];
  ...
  /*
  it('aggregates usage for an organization V2', (done) => {
    const now = new Date();
    const processed = [
      Date.UTC(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDate(), 0),
      Date.UTC(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDate(), 1),
    ...
    // Define a sequence of accumulated usage for several resource instances
    const usage = [
      accumulatedUsageV2('0b39fa70-a65f-4183-bae8-385633ca5c87', 1420243200000,
        1420245000000, processed[0], 'basic', 'common',
        { quantity: { current: 12 }, cost: 24 }, {
          quantity: { current: { consumed: 0, consuming: 6,
            since: 1420243200000 } },
          cost: { burned: 0, burning: 12, since: 1420243200000 } }),
      accumulatedUsageV2('0b39fa70-a65f-4183-bae8-385633ca5c87', 1420245000000,
        1420247000000, processed[1], 'basic', 'common',
          { quantity: { previous: 12, current: 22 }, cost: 44 },
          { quantity: {
            previous: { consumed: 0, consuming: 6, since: 1420243200000 },
            current: {
              consumed: 10800000, consuming: 4, since: 1420245000000
            }
          }, cost: { burned: 21600000, burning: 8, since: 1420245000000 } }),
      accumulatedUsageV2('1b39fa70-a65f-4183-bae8-385633ca5c88', 1420247000000,
        1420249000000, processed[2], 'basic', 'common',
        { quantity: { current: 8 }, cost: 16 }, {
          quantity: { current: { consumed: 0, consuming: 3,
            since: 1420247000000 }
          },
          cost: { burned: 0, burning: 6, since: 1420247000000 } }),
      accumulatedUsageV2('1b39fa70-a65f-4183-bae8-385633ca5c88', 1420249000000,
        1420251000000, processed[3], 'basic', 'common',
        { quantity: { previous: 8, current: 10 }, cost: 20 }, {
          quantity: {
            previous: { consumed: 0, consuming: 3, since: 1420247000000 },
            current: { consumed: 6000000, consuming: 2, since: 1420249000000 }
          },
          cost: { burned: 12000000, burning: 4, since: 1420249000000 } }),
      accumulatedUsageV2('0b39fa70-a65f-4183-bae8-385633ca5c87', 1420245100000,
        1420245300000, processed[4], 'standard', 'common',
        { quantity: { current: 12 }, cost: 24 }, {
          quantity: { current: { consumed: 0, consuming: 6,
            since: 1420243200000 } },
          cost: { burned: 0, burning: 12, since: 1420243200000 } }),
      accumulatedUsageV2('0b39fa70-a65f-4183-bae8-385633ca5c87', 1420245300000,
        1420245500000, processed[5], 'standard', 'discount',
        { quantity: { current: 12 }, cost: 24 }, {
          quantity: { current: { consumed: 0, consuming: 6,
            since: 1420243200000 } },
          cost: { burned: 0, burning: 12, since: 1420243200000 } })
      ...
      resources: [
        {
          ...
          aggregated_usage: [{
            ...
            windows: [
              ...
              [null],
              [null],
              [{ quantity: { consumed: 67600000, consuming: 12,
                since: 1420249000000 } }, null, null],
              [{ quantity: { consumed: 67600000, consuming: 12,
                since: 1420249000000 } }, null]]
          }],
              ...
              prices: [{
                ...
                aggregated_usage: [{
                  ...
                  windows: [
                    ...
                    [null],
                    [null],
                    [{ quantity: 12, cost: 2.16 }, null, null],
                    [{ quantity: 12, cost: 2.16 }, null]]
                }, {
                  metric: 'memory',
                  windows: [
                    [null],
                    ...
                    [{ quantity: { consumed: 0, consuming: 6,
                      since: 1420243200000 }, cost: { burned: 0,
                      burning: 0.00168, since: 1420243200000 } }, null, null],
                    [{ quantity: { consumed: 0, consuming: 6,
                      since: 1420243200000 }, cost: { burned: 0,
                      burning: 0.00168, since: 1420243200000 } }, null]]
                }]
              }]
            }]
          }]
                  ...
                  prices: [{
                    ...
                    aggregated_usage: [{
                      ...
                      windows: [
                        ...
                        [{ quantity: { consumed: 0, consuming: 6,
                          since: 1420243200000 }, cost: { burned: 0,
                          burning: 0.00168, since: 1420243200000 } },
                          null, null],
                        [{ quantity: { consumed: 0, consuming: 6,
                          since: 1420243200000 }, cost: { burned: 0,
                          burning: 0.00168, since: 1420243200000 } }, null]]
      ...
      resources: [
        {
          ...
          aggregated_usage: [{
            ...
            windows: [
              ...
              [null],
              [null],
              [{ quantity: { consumed: 102400000, consuming: 18,
                since: 1420249000000 } }, null, null],
              [{ quantity: { consumed: 102400000, consuming: 18,
                since: 1420249000000 } }, null]]
          }],
            ...
            rating_plans: [{
              ...
              aggregated_usage: [{
                ...
                windows: [
                  ...
                  [null],
                  [null],
                  [{ quantity: { consumed: 0, consuming: 12,
                    since: 1420243200000 } }, null, null],
                  [{ quantity: { consumed: 0, consuming: 12,
                    since: 1420243200000 } }, null]]
              }],
              prices: [{
                ...
                aggregated_usage: [{
                  ...
                  windows: [
                    ...
                    [null],
                    [null],
                    [{ quantity: 12, cost: 2.04 }, null, null],
                    [{ quantity: 12, cost: 2.04 }, null]]
                }, {
                  metric: 'memory',
                  windows: [
                    [null],
                    ...
                    [{ quantity: { consumed: 0, consuming: 6,
                      since: 1420243200000 }, cost: { burned: 0,
                      burning: 0.00162, since: 1420243200000 } }, null, null],
                    [{ quantity: { consumed: 0, consuming: 6,
                      since: 1420243200000 }, cost: { burned: 0,
                      burning: 0.00162, since: 1420243200000 } }, null]]
                }]
              }]
            }]
          }]
                  ...
                  prices: [{
                    ...
                    aggregated_usage: [{
                      ...
                      windows: [
                        ...
                        [{ quantity: { consumed: 0, consuming: 6,
                          since: 1420243200000 }, cost: { burned: 0,
                          burning: 0.00162, since: 1420243200000 } },
                          null, null],
                        [{ quantity: { consumed: 0, consuming: 6,
                          since: 1420243200000 }, cost: { burned: 0,
                          burning: 0.00162, since: 1420243200000 } }, null]]
    ...
    const verify = (secured, done) => {
      ...
      postspy = (reqs, cb) => {
        ...
        // Expect aggregated usage to be posted to a sink service
        expect(reqs[0][0])
          .to.equal('http://localhost:9400/v2/metering/aggregated/usage');

        // Expect our test aggregated values
        const val = reqs[0][1];
        expect(omit(val.body,
          'id', 'processed', 'accumulated_usage_v2_id')).to.deep.equal(
          extend({},
            omit(aggregated[posts], 'accumulated_usage_v2_id'), {
              organization_id: [
                'a3d7fe4d-3cb1-4cc3-a831-ffe98e20cf27',
                secured ? 1 : 0].join('-')
            }));
      ...
      const post = () => {
        ...
        transform.reduce(usage, (a, u, i, l, cb) => {
          ...
          request.post('http://localhost::p/v2/metering/accumulated/usage', {
            p: server.address().port,
            body: uval
          }, (err, val) => {
            expect(err).to.equal(undefined);
          ...
          // Check oauth validator spy
          expect(validatorspy.callCount).to.equal(secured ? 18 : 0);
  ...
  it('aggregator aggregates only to its relevant windows V2', (done) => {
    let records = 0;
    clock.restore();
    clock = sinon.useFakeTimers(Date.UTC(2015, 9, 31, 2), 'Date');
    const oct = {
    ...
    const usage = [
      accumulatedUsageV2('bounds', 1446249600000, 1446249600000, 1446256800000,
        'basic', 'common'),
      accumulatedUsageV2('bounds', 1446336000000, 1446336000000, 1446418800000,
        'basic', 'common'),
      accumulatedUsageV2('bounds', 1446415200000, 1446415200000, 1446418800000,
        'basic', 'common')
    ];
    usage[0].accumulated_usage = [{
      metric: 'memory',
