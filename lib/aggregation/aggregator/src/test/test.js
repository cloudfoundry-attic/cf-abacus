  ...
  it('aggregates usage for an organization', (done) => {
    ...
    const verify = (secured, done) => {
      ...
      const twindows = (dq, mq, dc, mc, pdq, pmq) => {
        ...
        win[3][0] = dc ? { quantity: dq, previous_quantity: pdq, cost: dc } :
          { quantity: dq, previous_quantity: pdq };
        win[4][0] = mc ? { quantity: mq, previous_quantity: pmq, cost: mc } :
          { quantity: mq, previous_quantity: pmq };
        return win;
      };

      // Helper function for creating org resources
      const resource = (apiDQ, apiMQ, memDQ, memMQ, apiDC, apiMC,
        memDC, memMC, papiDQ, papiMQ, pmemDQ, pmemMQ) => {
        return [{
          resource_id: 'test-resource',
          aggregated_usage: [{
            metric: 'heavy_api_calls',
            windows: twindows(apiDQ, apiMQ, null, null, papiDQ, papiMQ)
          }, {
            metric: 'memory',
            windows: twindows(memDQ, memMQ, null, null, pmemDQ, pmemMQ)
          }],
          plans: [{
            plan_id: pid,
            rating_plan_id: 'test-rating-plan',
      ...
      const aggregated = [{
        ...
        resources: resource(12, 12, { consumed: 518400000, consuming: 6 },
          ...
          { consumed: 13996800000, consuming: 6, price: 0.00014 }, null, null,
          null, null),
        spaces: [
          {
            space_id: 'aaeae239-f3f8-483c-9dd0-de5d41c38b6a',
            resources: resource(12, 12, { consumed: 518400000, consuming: 6 },
              { consumed: 13996800000, consuming: 6 }, 1.8, 1.8,
              { consumed: 518400000, consuming: 6, price: 0.00014 },
              { consumed: 13996800000, consuming: 6, price: 0.00014 }, null,
              null, null, null),
        ...
        resources: resource(22, 22, { consumed: 684000000, consuming: 8 },
          ...
          { consumed: 18655200000, consuming: 8, price: 0.00014 }, 12, 12,
        ...
        resources: resource(30, 30, { consumed: 920400000, consuming: 11 },
          ...
          { consumed: 25630800000, consuming: 11, price: 0.00014 }, 22, 22,
        ...
        resources: resource(32, 32, { consumed: 845600000, consuming: 10 },
          ...
          { consumed: 23309600000, consuming: 10, price: 0.00014 }, 30, 30,
      ...
      const cresource = (apiDQ, apiMQ, memDQ, memMQ, apiDC, apiMC,
        memDC, memMC, usages, papiDQ, papiMQ, pmemDQ, pmemMQ) => {
        return [{
          resource_id: 'test-resource',
          aggregated_usage: [{
            metric: 'heavy_api_calls',
      ...
      const consumers = [{
        ...
        resources: cresource(22, 22, { consumed: 684000000, consuming: 8 },
          ...
          12, 12, { consumed: 518400000, consuming: 6 },
          { consumed: 13996800000, consuming: 6 })
      },{
        consumer_id: 'external:bbeae239-f3f8-483c-9dd0-de6781c38bab',
        organization_id: 'a3d7fe4d-3cb1-4cc3-a831-ffe98e20cf28',
        ...
        resources: cresource(30, 30, { consumed: 920400000, consuming: 11 },
          ...
          usage[2]], 22, 22, { consumed: 684000000, consuming: 8 },
          { consumed: 18655200000, consuming: 8 })
      },{
        consumer_id: 'external:bbeae239-f3f8-483c-9dd0-de6781c38bab',
        organization_id: 'a3d7fe4d-3cb1-4cc3-a831-ffe98e20cf28',
        ...
        resources: cresource(32, 32, { consumed: 845600000, consuming: 10 },
          ...
          usage[3]], 30, 30, { consumed: 920400000, consuming: 11 },
          { consumed: 25630800000, consuming: 11 })
      }];
  ...
  it('shifts all windows successfully', (done) => {
    ...
    const expected = {
      ...
      windows: [[null], [null], [null],
        [{ quantity: 500, previous_quantity: null },
         { quantity: 1000 }, null],
        [{ quantity: 500, previous_quantity: null },
         { quantity: 1000 }]]
    };
    const expectedBasic = {
      metric: 'heavy_api_calls',
      windows: [[null], [null], [null],
        [{ quantity: 500, previous_quantity: null, cost: 75 },
         { quantity: 500, cost: 75 }, null],
        [{ quantity: 500, previous_quantity: null, cost: 75 },
        { quantity: 500, cost: 75 }]]
    };
  ...
  it('processed time falls in prev day/month', (done) => {
    ...
    const expected = {
      ...
      windows: [[null], [null], [null],
        ...
        [{ quantity: 700, previous_quantity: 300 },
         { quantity: 300 }]]
    };
    const expectedBasic = {
      metric: 'heavy_api_calls',
      windows: [[null], [null], [null],
        ...
        [{ quantity: 700, previous_quantity: 300, cost: 105 },
         { quantity: 300, cost: 45 }]]
    };
