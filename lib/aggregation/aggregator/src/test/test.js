  ...
  it('shifts all windows successfully', (done) => {
    ...
    const expectedBasic = {
      ...
      windows: [
        ...
        [null],
        [null],
        [{ quantity: 500, previous_quantity: null }, { quantity: 500 }, null],
        [{ quantity: 500, previous_quantity: null }, { quantity: 500 }]
      ]
    };
    const expectedStandard = {
      metric: 'heavy_api_calls',
      windows: [[null], [null], [null], [null, { quantity: 500 }, null], [null, { quantity: 500 }]]
    };
  ...
  it('processed time falls in prev day/month', (done) => {
    ...
    const expectedBasic = {
      ...
      windows: [
        ...
        [{ quantity: 700, previous_quantity: 300 }, { quantity: 300 }]
      ]
    };
