...
const pid = 'basic/basic-test-metering-plan/' +
...
describe('abacus-usage-aggregator', () => {
  ...
  it('aggregator selects the correct time window to aggregate to', (done) => {
    ...
    const jan1 = {
      quantity: {
        current: { consumed: 0, consuming: 2, since: 1454198400000 }
      },
      cost: { burned: 0, burning: 0.00028, since: 1454198400000 }
    };
    const jan2 = {
      quantity: {
        previous: { consumed: 0, consuming: 2, since: 1454198400000 },
        current: { consumed: 57600000, consuming: 1, since: 1454227200000 }
      },
      cost: { burned: 8064, burning: 0.00014, since: 1454227200000 }
    };
    const feb = {
      quantity: {
        current: { consumed: 0, consuming: 2, since: 1454299200000 }
      },
      cost: { burned: 0, burning: 0.00028, since: 1454299200000 }
    };
    const usage = [
    ...
    usage[0].accumulated_usage = [{
      metric: 'memory',
      windows: [[null], [null], [null], [jan1, null, null], [jan1, null]]
    }];
    usage[1].accumulated_usage = [{
      metric: 'memory',
      windows: [[null], [null], [null], [null, jan2, null], [null, jan2]]
    }];
    usage[2].accumulated_usage = [{
      metric: 'memory',
      windows: [[null], [null], [null], [feb, jan2, null], [feb, jan2]]
    }];
    ...
    const expected = [[null],[null],[null],
      [
        {
          quantity: { consuming: 2, consumed: 0, since: 1454299200000 },
          cost: { burning: 0.00028, burned: 0, since: 1454299200000 }
        },
        {
          quantity: { consuming: 1, consumed: 57600000, since: 1454227200000 },
          cost: { burning: 0.00014, burned: 8064, since: 1454227200000 }
        },
        null
      ],
      [
