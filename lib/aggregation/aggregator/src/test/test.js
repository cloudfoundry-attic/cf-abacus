...
describe('abacus-usage-aggregator', () => {
  it('constructs aggregated usage for an organization', () => {
    ...
    agg[0].service('1234').plan('plan_123').resource('calls').quantity = 12;
    agg[0].space('space_567').service('1234').resource('calls').quantity = 12;
    agg[0].space('space_567').service('1234').plan('plan_123')
      .resource('calls').quantity = 12;
    agg[0].space('space_567').consumer('123').service('1234')
      .resource('calls').quantity = 12;
    agg[0].space('space_567').consumer('123').service('1234')
      .plan('plan_123').resource('calls').quantity = 12;
    ...
    agg[1].service('1234').plan('plan_123').resource('calls').quantity = 22;
    agg[1].space('space_567').service('1234').resource('calls').quantity = 22;
    agg[1].space('space_567').service('1234').plan('plan_123')
      .resource('calls').quantity = 22;
    agg[1].space('space_567').consumer('123').service('1234')
      .resource('calls').quantity = 22;
    agg[1].space('space_567').consumer('123').service('1234')
      .plan('plan_123').resource('calls').quantity = 22;
