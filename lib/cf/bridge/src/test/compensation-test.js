...
describe('Purge compensation', () => {
  ...
  const deleteModules = () => {
    ...
    delete require.cache[require.resolve('pouchdb')];
    delete require.cache[require.resolve('pouchdb-all-dbs')];
  ...
  context('on success', () => {
    context('for STARTED app usage event', () => {
      ...
      it('generates correct usage request', (done) => {
        bridge.purgeCompensation(cfToken, abacusToken, (error, response) => {
      ...
      it('receives correct usage response', (done) => {
        bridge.purgeCompensation(cfToken, abacusToken, (err, response) => {
    ...
    context('for STOPPED app usage event', () => {
      ...
      it('generates no compensation usage reporting request',
        (done) => {
          bridge.purgeCompensation(cfToken, abacusToken, (error) => {
            done(error);
          });
  ...
  context('when bridge is restarted', () => {
    ...
    runWithPersistentDB('uses the last processed guid', (done) => {
      setTimeout(() => {
        // Do not start store cache timer
