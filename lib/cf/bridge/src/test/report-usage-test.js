...
const tests = (secured) => {
  ...
  const generateUsageReport = (resourceId, currentInstanceMemory,
  ...
  const checkUsageReport = (done, currentInstanceMemory,
                            currentInstances, previousInstanceMemory,
                            previousInstances) => {
    ...
    expect(args[0][1].body).to.deep.equal(
      generateUsageReport('35c4ff2f', currentInstanceMemory, currentInstances,
    ...
    context('with multiple pages', () => {
      ...
      const checkPostRequest = (req, resourceId) => {
        ...
        expect(req[1].body).to.deep.equal(
          generateUsageReport(resourceId, 536870912, 1, 268435456, 2));
      };
      ...
      context('for starting app', () => {
        ...
        it('reports app usage event', (done) => {
          bridge.reportAppUsage(cfToken, abacusToken, {
            ...
            success: () => {
              bridge.stopReporting();
              checkUsageReport(done, 536870912, 1, 0, 0);
            }
          });
        });
      });
      ...
      context('for scaling app', () => {
        ...
        it('reports app usage event', (done) => {
          bridge.reportAppUsage(cfToken, abacusToken, {
            ...
            success: () => {
              bridge.stopReporting();
              checkUsageReport(done, 536870912, 1, 268435456, 2);
            }
          });
        });
      });
      ...
      context('for stopping app', () => {
        ...
        it('reports app usage event', (done) => {
          bridge.reportAppUsage(cfToken, abacusToken, {
            ...
            success: () => {
              bridge.stopReporting();
              checkUsageReport(done, 0, 0, 268435456, 2);
            }
          });
        });
      });
