...
const buildAppUsage = (event, stopped = false) => {
  let currentRunningInstances = event.entity.instance_count;
  let previousRunningInstances = event.entity.previous_instance_count;
  let currentInstanceMemory =
    event.entity.memory_in_mb_per_instance * 1048576;
  let previousInstanceMemory =
    ...
    usage: {
      ...
      measured_usage: [
        ...
        },
        {
          ...
          quantity: currentRunningInstances
        },
        {
        ...
        },
        {
          ...
          quantity: previousRunningInstances
        }
      ]
    }
  };
