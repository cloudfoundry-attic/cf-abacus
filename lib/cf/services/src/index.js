...
const eventMapper = require('./service-event-mapper');
const converter = require('./service-event-converter');
...
class ServiceBridgeApplication extends Application {
  ...
  *createEventConverter() {
    return converter(eventMapper(precedingUsagesReader(this.carryOver, this.serviceCfg.pageSize))).convertEvent;
  }
