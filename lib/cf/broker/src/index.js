...
routes.put('/v2/service_instances/:instance_id',
  basicAuth, createService(serviceMappingClient, provisioningClient, config, planBuilder).createService);
...
routes.patch('/v2/service_instances/:instance_id',
  basicAuth, updateService(serviceMappingClient, provisioningClient, config, planBuilder).updateService);;
