...
describe('Create service instance', () => {
  ...
  beforeEach(() => {
    ...
    createService = require('../../routes/create-service.js')(serviceMappingClientStub);
  });

  context('when error', () => {

    const validateErrorInPlansCreation = (callCount, expectedCode, done) =>
    ...
    it('500 is returned during plan creation, it should fail ', (done) => {
      ...
      validateErrorInPlansCreation(1, httpStatus.INTERNAL_SERVER_ERROR, done);
    });
    ...
    it('404 is returned during plan creation, it should fail', (done) => {
      ...
      validateErrorInPlansCreation(1, httpStatus.NOT_FOUND, done);
    });
    ...
    it('in first create of plan mapping occurs, it should fail', (done) => {
      ...
      validateErrorInPlansCreation(4, httpStatus.BAD_REQUEST, done);
    });
  });
