...
const serviceUpdaterFactory = require('../../routes/update-service');
...
describe('Update Service', () => {
  ...
  context('when updateService is called', () => {
    ...
    let createServiceMappingClientStub;
    ...
    beforeEach(async () => {
      ...
      createServiceMappingClientStub = sinon.stub();
      createServiceMappingClientStub.withArgs(mappingApi).returns(serviceMappingClientStub);

      serviceUpdater = serviceUpdaterFactory(createServiceMappingClientStub,
        provisioningClientStub,
        configStub,
        planBuilderStub
      );
    ...
    it('should validate request parameters', async () => {
      await serviceUpdater.updateService(requestWithResourceProvider, response);
    ...
    context('when request parameters validation is successful', () => {
      ...
      context('when request does NOT contain resource provider', () => {
        ...
        beforeEach(async () => {
          ...
          await serviceUpdater.updateService(requestWithoutResourceProvider, response);
        });
    ...
    context('when request parameters are not provided', () => {
      ...
      beforeEach(async () => {
        await serviceUpdater.updateService(requestWithoutParameters, response);
      });
