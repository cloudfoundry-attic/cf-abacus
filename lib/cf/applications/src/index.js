...
const minIntervalTime = parseInt(process.env.MIN_INTERVAL_TIME) || 30000;
...
const resultsPerPage = parseInt(process.env.API_PAGE_SIZE) || 100;
...
const reportAppUsage = (cfToken, abacusToken, { failure, success }) => {
  ...
  let uri = '/v2/app_usage_events?order-direction=asc&results-per-page=' +
    resultsPerPage;
