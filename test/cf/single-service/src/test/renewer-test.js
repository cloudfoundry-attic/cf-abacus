...
// Setup the debug log
const debug =
  require('abacus-debug')('abacus-cf-single-service-renewer-itest');
const responseDebug =
  require('abacus-debug')('abacus-cf-single-service-renewer-itest-response');
const resultDebug =
  require('abacus-debug')('abacus-cf-single-service-renewer-itest-result');
const oAuthDebug =
  require('abacus-debug')('abacus-cf-single-service-renewer-itest-oauth');
...
describe.skip('abacus-cf-single-service-renewer-itest without oAuth', () => {
  let server;
  let serverPort;
