...
// Setup the debug log
const debug =
  require('abacus-debug')('abacus-cf-applications-slack-itest');
const responseDebug =
  require('abacus-debug')('abacus-cf-applications-slack-itest-response');
const resultDebug =
  require('abacus-debug')('abacus-cf-applications-slack-itest-result');
const oAuthDebug =
  require('abacus-debug')('abacus-cf-applications-slack-itest-oauth');
