...
// Setup the debug log
const debug =
  require('abacus-debug')('abacus-cf-renewer-apps-slack-itest');
const responseDebug =
  require('abacus-debug')('abacus-cf-renewer-apps-slack-itest-response');
const resultDebug =
  require('abacus-debug')('abacus-cf-renewer-apps-slack-itest-result');
const oAuthDebug =
  require('abacus-debug')('abacus-cf-renewer-apps-slack-itest-oauth');
