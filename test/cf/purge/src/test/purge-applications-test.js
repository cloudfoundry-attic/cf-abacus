...
// Setup the debug log
const debug =
  require('abacus-debug')('abacus-cf-applications-purge-itest');
const responseDebug =
  require('abacus-debug')('abacus-cf-applications-purge-itest-response');
const resultDebug =
  require('abacus-debug')('abacus-cf-applications-purge-itest-result');
const oAuthDebug =
  require('abacus-debug')('abacus-cf-applications-purge-itest-oauth');
