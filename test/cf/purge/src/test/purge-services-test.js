...
// Setup the debug log
const debug =
  require('abacus-debug')('abacus-cf-services-purge-itest');
const responseDebug =
  require('abacus-debug')('abacus-cf-services-purge-itest-response');
const resultDebug =
  require('abacus-debug')('abacus-cf-services-purge-itest-result');
const oAuthDebug =
  require('abacus-debug')('abacus-cf-services-purge-itest-oauth');
...
const test = (secured) => {
  ...
  beforeEach((done) => {
    ...
    process.env.CF_CLIENT_ID = 'abacus-cf-services';
